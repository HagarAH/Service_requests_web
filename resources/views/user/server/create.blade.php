...
@section('content')
    ...
    <div class="page-content">
        <div class="col-xl-6 pb-3">
            <form action="{{route('server.store')}}"
                  method="POST"
                ...
                <div class="d-flex justify-content-center p-2 bg-primary-50">
                    <div class="panel-content" data-select2-id="36">
                        ...
                        <div class="form-group" data-select2-id="100">
                            ...
                            <select name="cpu_id" class="select2 form-control w-100 select2-hidden-accessible" id="single-default"
                            ...
                            <select name="ram_id" class="select2 form-control w-100 select2-hidden-accessible" id="single-default"
                                    data-select2-id="single-default" tabindex="-1" aria-hidden="true">
                                <optgroup data-select2-id="101">
                                    @foreach($rams as $ram)
                            ...
                            <select name="disk_id" class="select2 form-control w-100 select2-hidden-accessible" id="single-default"
                                    data-select2-id="single-default" tabindex="-1" aria-hidden="true">
                                <optgroup data-select2-id="101">
                            ...
                            <select name="system_id" class="select2 form-control w-100 select2-hidden-accessible" id="single-default"
                                    data-select2-id="single-default" tabindex="-1" aria-hidden="true">
                                <optgroup data-select2-id="101">
                        ...
                        <div class="form-group">
                            ...
                            <input name="kayit" type="text" id="simpleinput" class="form-control">
                        </div>
                        ...
                        <div class="frame-wrap p-1 mb-2">
                            ...
                            <div class="demo">
                                <div class="custom-control custom-radio custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="defaultUncheckedRadio" name="ag" value="dis_ag">
                                    <label class="custom-control-label" for="defaultUncheckedRadio">Dış Ağ</label>
                                </div>
                                <div class="custom-control custom-radio custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="defaultCheckedRadio" name="ag" value="ic_ag" checked="">
                        ...
                        <div class="form-group">
                            ...
                            <input name="reason" type="text" id="simpleinput" class="form-control">
                        </div>
