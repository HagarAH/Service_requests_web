                ...
                <div class="panel-content">
                    <form action="{{route('Post.store')}}"
                        ...
                        <div class="panel-content" data-select2-id="36">
                            <div class="panel-tag">
                                User request form (Please make sure to specify needs correctly)
                            </div>
                            <div class="form-group" data-select2-id="100">
                                ...
                                <div class="form-group mt-2" >
                                    ...
                                    <textarea name="description" class="form-control" id="example-textarea" rows="5" required></textarea>
                                </div>
