    ...
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> Diskdisk Eklemek
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-6">
                        ...
                        <div class="panel-content">
                            ...
                            <form action="{{ route('disk.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="read_speed" type="text" class="form-control">
                                    @error('read_speed')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input name="write_speed" type="text" class="form-control">
                                    @error('write_speed')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
